...
*/
    ...
    {
		return RanCraftPenguins.PengSkinBlue;
    }
     ...
     */
	@Override
	  public boolean canMateWith(EntityAnimal paramEntityAnimal)
	  {
	     if (paramEntityAnimal == this) return false;
	     if (!isTamed()) return false;
	     if (!(paramEntityAnimal instanceof EntityPenguinLB)) return false;
	     EntityPenguinLB localEntityPenguin = (EntityPenguinLB)paramEntityAnimal;
	     if (!localEntityPenguin.isTamed()) return false;
	     if (localEntityPenguin.isSitting()) return false;
	     return (isInLove()) && (localEntityPenguin.isInLove());
	  }
