...
public class EntityAISitCust extends EntityAIBase
{
    ...
    public EntityAISitCust(EntityTameable par1EntityTameable)
    {
    ...
    {
		//System.out.printf("cust: The sitting tag was this: %b\n", this.isSitting);
        this.isSitting = par1;
        this.theEntity.setSitting(par1);
		//System.out.printf("cust: Set the sitting tag to this: %b\n", this.isSitting);
    }

    /**
     * Gets the sitting flag.
     */
    public boolean getSitting()
    {
		//System.out.printf("cust: Sending cust's sitting tag\n");
