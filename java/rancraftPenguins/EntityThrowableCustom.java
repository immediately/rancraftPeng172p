...
/* used for shurikens to allow them to stick in the ground and do damage independently of draw-back */
...
public abstract class EntityThrowableCustom extends Entity implements IProjectile
{
    ...
    public EntityThrowableCustom(World par1World)
    {
        super(par1World);
    ...
    public EntityThrowableCustom(World par1World, EntityPlayer par2EntityLiving)
    {
        super(par1World);
    ...
    public EntityThrowableCustom(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
    ...
    public void onUpdate()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            double d0 = 0.0D;
            EntityPlayer entityliving = this.getThrower();
        ...
        if (movingobjectposition != null) // got a movingobjectposition
        {
            if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && this.worldObj.getBlock(movingobjectposition.blockX, movingobjectposition.blockY, movingobjectposition.blockZ) == Blocks.portal)
            {
                //this.setInPortal();
                inGround = false; // for damage
            }
            else
            {
            	if(hitEntity){
	            	...
	            	inGround = true; // this makes it stick, but if thrower is too close, it goes back
	            	this.motionX = 0;
	            	this.motionY = 0;
	            	this.motionZ = 0;
            	}
				//System.out.printf("mopY = %d; thisPosY = %f\n", movingobjectposition.blockY, this.posY);
        ...
        /*    if (var3 != null)
        {
        	...
        	if(hitEntity){
            	...
            	inGround = true; // this makes it stick, but just offset a block.
            	this.motionX = 0;
            	this.motionY = 0;
            	this.motionZ = 0;
            	//this.posY--; // force it down
        	}
        }*/
    ...
    public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        {
            this.throwerName = this.thrower.getDisplayName();
        }
