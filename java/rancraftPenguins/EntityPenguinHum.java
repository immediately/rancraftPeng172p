...
public class EntityPenguinHum extends EntityPenguin
{
    final float MAXHEALTHWILD = 6;
    final float MAXHEALTHTAME = 15;
    ...
    public EntityPenguinHum(World par1World)
    {
        super(par1World);
    ...
    protected String getLivingSound()
    {
        if (isAngry())
        {
            return RanCraftPenguins.modID+":penguinHum.angry";
        }

        if (rand.nextInt(RanCraftPenguins.pengQuietInt) == 0) {
	        if(dataWatcher.getWatchableObjectFloat(18) < healthQuartile1) {
	    		return RanCraftPenguins.modID+":penguinHum.healthd";
	    	} else if(dataWatcher.getWatchableObjectFloat(18) < healthQuartile2) {
	    		return RanCraftPenguins.modID+":penguinHum.healthc";
	    	} else if(dataWatcher.getWatchableObjectFloat(18) < healthQuartile3) {
	    		return RanCraftPenguins.modID+":penguinHum.healthb";
	    	} else {
	    		return RanCraftPenguins.modID+":penguinHum.healtha";
	    	}
        } else {
        	return null;
        }
    ...
    {
        return RanCraftPenguins.modID+":penguinHum.hurt";
    }
    ...
    {
        return RanCraftPenguins.modID+":penguinHum.death";
    }
...
*/
    ...
    public Item droppedFeather()
    {
		...
		if(i > 0){ // 75% brown striped, 25% white
     ...
     */
    public EntityPenguinHum spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        EntityPenguinHum var2 = new EntityPenguinHum(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof EntityPenguinHum))
        {
            return false;
        }
        else
        {
            EntityPenguinHum var2 = (EntityPenguinHum)par1EntityAnimal;
